...
const Footer = () => {
  ...
  return (
    <div className='w-full bg-gray1100 pt-[100px] pb-[100px] px-8 lg:px-20 flex flex-col justify-start items-start'>
      <div className='flex flex-row items-center justify-center gap-2 z-20 mb-2'>
        <img src="/landing/logo.png" alt="" className='w-[54px] h-[45px]' />
        <h3 className='text-[29px] text-white font-semibold'>ALUAM</h3>
      </div>
      <h3 className='text-[24px] text-gray300 mb-8'>Las Jarillas 2500 Local 4, San Luis, x5700</h3>
      <div className='flex flex-row items-center justify-start gap-4 mb-4'>
        ...
        <a target='_blank' href={`https://wa.me/+5492664655398?text=${text}`}>
          <h3 className='text-[24px] text-gray300 font-semibold '>+5492664655398</h3>
        </a>
      </div>
      <div className='flex flex-row items-center justify-start gap-4 mb-4'>
