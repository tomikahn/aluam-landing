  ...
  return (
    <div className='w-full px-8 lg:px-20 pb-[100px]'>
      <div className='flex flex-row items-center justify-center sm:justify-center sm:items-center gap-20 xl:gap-[150px]'>
        <img src="/landing/product1.png" alt="" className='hidden sm:flex xl:w-[300px]' />
        <div className='flex flex-col items-start justify-start sm:w-[50%]'>
          ...
          <p className='text-[20px] text-gray500 mb-6 lg:max-w-[90%]'>Explora nuestra línea de aberturas de aluminio, donde nos especializamos en opciones de media y alta prestación. En Aluam, fusionamos resistencia y estilo para proporcionarte aberturas que destacan por su calidad y diseño excepcionales.</p>
